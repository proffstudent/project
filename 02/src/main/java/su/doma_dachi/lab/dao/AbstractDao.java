...
public abstract class AbstractDao<T extends Identified<PK>, PK extends Integer> implements GenericDao<T, PK> {
    ...
    protected Identified getDependence(Class<? extends Identified> dtoClass, Serializable pk) throws PersistException, SQLException {
        return (Identified) parentFactory.getDao(connection, dtoClass).getByPK((Integer) pk);
    }
